...
class UnblacklistClientRequest:
    client_id: UUID


class UnblacklistClient:
    def __init__(
        self,
    ...
    async def execute(self, request: UnblacklistClientRequest) -> None:
        logger.info("Unblacklist client: started.")
        ...
        logger.info("Unblacklist client: done.")
