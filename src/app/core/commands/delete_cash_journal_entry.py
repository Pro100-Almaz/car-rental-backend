...
class DeleteCashJournalEntryRequest:
    entry_id: UUID


class DeleteCashJournalEntry:
    def __init__(
        self,
    ...
    async def execute(self, request: DeleteCashJournalEntryRequest) -> None:
        logger.info("Delete cash journal entry: started.")
        ...
        authorize(
            ...
            context=PermissionCheckContext(
                ...
                required_permission="finance.cash_journal.delete",
            ),
        )
        ...
        await self._cash_journal_tx_storage.delete(entry)
        await self._transaction_manager.commit()

        logger.info("Delete cash journal entry: done.")
