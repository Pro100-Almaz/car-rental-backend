...
from app.presentation.http.payments.confirm_payment import make_confirm_payment_router
...
from app.presentation.http.payments.list_pending_payments import make_list_pending_payments_router
...
from app.presentation.http.payments.reject_payment import make_reject_payment_router
...
def make_payments_router() -> APIRouter:
    ...
    router.include_router(make_list_pending_payments_router())
    ...
    router.include_router(make_confirm_payment_router())
    router.include_router(make_reject_payment_router())
    return router
