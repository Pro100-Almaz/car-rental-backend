...
class ChargeClientResponse(TypedDict):
    id: UUID
    created_at: datetime
...
class ChargeClient:
    ...
    async def execute(self, request: ChargeClientRequest) -> ChargeClientResponse:
        logger.info("Charge client: started.")
        ...
        logger.info("Charge client: done.")
        return ChargeClientResponse(
            id=transaction.id_,
