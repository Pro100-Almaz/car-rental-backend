...
class HoldDepositResponse(TypedDict):
    id: UUID
    created_at: datetime
...
class HoldDeposit:
    ...
    async def execute(self, request: HoldDepositRequest) -> HoldDepositResponse:
        logger.info("Hold deposit: started.")
        ...
        transaction = Transaction(
            ...
            type_=TransactionType.DEPOSIT_HOLD,
        ...
        logger.info("Hold deposit: done.")
        return HoldDepositResponse(
            id=transaction.id_,
