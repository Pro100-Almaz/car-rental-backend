...
from app.presentation.http.cash_journal.delete_entry import make_delete_entry_router
from app.presentation.http.cash_journal.export_entries import make_export_entries_router
...
def make_cash_journal_router() -> APIRouter:
    ...
    router.include_router(make_export_entries_router())
    ...
    router.include_router(make_delete_entry_router())
    return router
