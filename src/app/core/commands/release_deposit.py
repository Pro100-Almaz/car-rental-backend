...
class ReleaseDepositResponse(TypedDict):
    id: UUID
    created_at: datetime


class ReleaseDeposit:
    def __init__(
        self,
    ...
    async def execute(self, request: ReleaseDepositRequest) -> ReleaseDepositResponse:
        logger.info("Release deposit: started.")
        ...
        logger.info("Release deposit: done.")
