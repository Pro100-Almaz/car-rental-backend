"""Internal job endpoint: check-pickup-reminders."""
...
def make_check_pickup_reminders_router() -> APIRouter:
    router = APIRouter()
    ...
    async def check_pickup_reminders(
        request: Request,
        interactor: FromDishka[CheckPickupReminders],
        ...
        audit(
            ...
            job_name="check-pickup-reminders",
            ip=client_ip,
